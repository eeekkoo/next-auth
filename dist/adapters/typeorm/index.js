    ...
    _getAdapter = _asyncToGenerator(function* (appOptions) {
      ...
      function _getUserByProviderAccountId() {
        _getUserByProviderAccountId = _asyncToGenerator(function* (providerId, providerAccountId) {
          ...
          try {
            var _account = yield manager.findOne(Account, {
              providerId,
              providerAccountId
            });
      ...
      function getUserFromUsersByProviderAccountId(_x7) {
        return _getUserFromUsersByProviderAccountId.apply(this, arguments);
      }

      function _getUserFromUsersByProviderAccountId() {
        _getUserFromUsersByProviderAccountId = _asyncToGenerator(function* (providerAccountId) {
          debug('GET_USER_FROM_USERS_BY_PROVIDER_ACCOUNT_ID', providerAccountId);

          try {
            return yield manager.findOne(User, {
              providerAccountId
            });
            ...
            logger.error('GET_USER_FROM_USERS_BY_PROVIDER_ACCOUNT_ID_ERROR', error);
            return Promise.reject(new Error('GET_USER_FROM_USERS_BY_PROVIDER_ACCOUNT_ID_ERROR', error));
          }
        });
        return _getUserFromUsersByProviderAccountId.apply(this, arguments);
      }
      ...
      function _linkAccount() {
        _linkAccount = _asyncToGenerator(function* (userId, providerId, providerType, providerAccountId, refreshToken, accessToken, accessTokenExpires) {
          ...
          try {
            var _account2 = new Account(userId, providerId, providerType, providerAccountId, refreshToken, accessToken, accessTokenExpires);

            return manager.save(_account2);
          } catch (error) {
      ...
      return Promise.resolve({
        ...
        getUserFromUsersByProviderAccountId,
        updateUser,
        deleteUser,
        linkAccount,
        unlinkAccount,
